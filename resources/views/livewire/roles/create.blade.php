<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900">Tambah Role Baru</h1>
            ...
            <div class="space-y-6 p-6">
                ...
                <div class="max-w-md">
                    ...
                    <input
                        ...
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-xs focus:border-blue-500 focus:ring-blue-500"
                    >
                    @error('name')
                    ...
                    <div class="flex items-center justify-between gap-2">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                Pilih permissions yang boleh digunakan oleh role ini.
                            </p>
                        </div>
                        <button
                            type="button"
